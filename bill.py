...
#==========Cold Drink Frame====================
        ...
        c2_lbl=Label(F4,text="cold_drink_price",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        c2_cream_txt=Entry(F4,width=10,textvariable=self.cold_drink_price,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)
        ...
        m2_txt=Entry(F6,width=18,font="arial 10 bold",textvariable=self.grocery__price,bd=7,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=1)
        ...
        btn_f.place(x=760,width=745,height=105)
        
        total_btn=Button(btn_f,command=self.total,text="Total",bg="cadetblue",fg="white",bd=10,pady=15,width=14,font="arial 12 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_f,text="Genrate Bill",command=self.bill_area,bg="cadetblue",fg="white",bd=10,pady=15,width=14,font="arial 12 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_f,text="Clear",command=self.clear_data,bg="cadetblue",fg="white",bd=10,pady=15,width=14,font="arial 12 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_f,text="Exit",command=self.Exit_app,bg="cadetblue",fg="white",bd=10,pady=15,width=14,font="arial 12 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        self.grocery__price.set("Rs."+str(self.total_grocery_price))
        self.g_tax=round((self.total_grocery_price*0.1),2)
        self.grocery_tax.set("Rs. "+str(self.g_tax))
        
       
        self.d_m_p=self.maza.get()*60
        self.d_c_p=self.cold_drink_price.get()*60
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get()=="":
            ...
            if self.gell.get()!=0:
                self.txtarea.insert(END,f"\n Hair Gell\t\t{self.soap.get()}\t\t{self.c_hg_p}")  
            ...
            if self.cold_drink_price.get()!=0:
                self.txtarea.insert(END,f"\n cold_drink_price\t\t{self.cold_drink_price.get()}\t\t{self.d_c_p}")       
